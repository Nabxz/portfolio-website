...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document
    .getElementById('missionPrevBtn')
    .addEventListener('click', function () {
      currentSlideIndex =
        currentSlideIndex > 0 ? currentSlideIndex - 1 : totalSlides - 1
      updateSlides()
    })

  document
    .getElementById('missionNextBtn')
    .addEventListener('click', function () {
...
document
  .querySelector('.planet-search-input-white')
...
function hideSearchResults () {
  ...
  const resultsContainer = document.getElementById(
    'all-planet-search-results-white'
  )
  if (resultsContainer) {
